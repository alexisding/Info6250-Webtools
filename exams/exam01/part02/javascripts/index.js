...
let playerHistoryGuess = [];
let computerHistoryGuess = [];
let computerGuessedWords = [];
let count = 0;
let playerBaseWord;
let computerBaseWord;
let playerWon;
let computerWon;
let playerSimilarLetters;
let computerSimilarLetters;
let isBegin;

const playerGuess = document.querySelector('.player-guess');
let computerGuess = document.querySelector('.computer-guess');
const button = document.querySelector('button');
const playerGuessList = document.querySelector('.player-guess-list');
const computerGuessList = document.querySelector('.computer-guess-list');
